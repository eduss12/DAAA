            ...
            VStack {
                ScrollView {
                    VStack(spacing: 25) {
                        ...
                        Section(header: Text("Criptomoneda").font(.headline).foregroundColor(.primary)) {
                        ...
                        // Sección de Configuración de Alerta
                        Section(header: Text("Configuración de la Alerta").font(.headline).foregroundColor(.primary)) {
                ...
                // Barra de acción para guardar o cancelar
                HStack {
                    Spacer()
